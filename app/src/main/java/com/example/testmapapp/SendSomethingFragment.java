 ...
 * Use the {@link SendSomethingFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SendSomethingFragment extends Fragment implements PermissionsListener {
     ...
     * @return A new instance of fragment SendSomethingFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SendSomethingFragment newInstance(String param1, String param2) {
        SendSomethingFragment fragment = new SendSomethingFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_send_something, container, false);
    }
    Style styleapp;
...
//                LatLng placeLatLng = (LatLng) selectedPlace.geometry();
                ...
                editor.apply();
                LatLng latLng=new LatLng(((Point) point).latitude(),((Point) point).longitude());
